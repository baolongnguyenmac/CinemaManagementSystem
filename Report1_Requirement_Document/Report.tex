...
\begin{document}
    ...
    \begin{itemize}
        ...
        \begin{table}[H]
            ...
            Kịch bản phụ            & \begin{tabular}[c]{@{}l@{}}Tại bước 3, trong trường hợp bộ phim chưa có lịch chiếu, website \\sẽ để trống ở phần thông tin lịch chiếu \end{tabular}       \\ \hline
            Ràng buộc phi chức năng & Thời gian phản hồi của hệ thống dưới 1s               \\ \hline
            \end{tabular}
    ...
    \begin{itemize}
        ...
        \item Use case Đặt vé
        \begin{figure}[H]
            \includegraphics[scale = 0.65]{SequenceDiagram/Đặt vé.png}
        ...
        \item Use case Thanh toán online
        \begin{figure}[H]
            \includegraphics[scale = 0.7]{SequenceDiagram/Thanh toán.png}
    ...
    \begin{figure}[H]
        \begin{center}
            \includegraphics[angle=90, scale = 0.55]{PlanDiagram/grantchart1.PNG}
    ...
    \begin{figure}[H]
        \begin{center}
            \includegraphics[angle=90, scale = 0.55]{PlanDiagram/Assignment.PNG}
