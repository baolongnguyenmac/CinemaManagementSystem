...
\begin{document}
    ...
    \begin{table}[H]
        \begin{tabular}{ccl}
            \hline
            \multicolumn{1}{|c|}{ID}  & \multicolumn{1}{c|}{Trọng số} & \multicolumn{1}{c|}{Yêu cầu chức năng}                                                                \\ \hline
            \multicolumn{1}{|c|}{1.1} & \multicolumn{1}{c|}{}         & \multicolumn{1}{l|}{Hệ thống sẽ cho phép người dùng Đăng ký/Đăng nhập/Đăng xuất tài khoản của họ}     \\ \hline
            \multicolumn{1}{|c|}{1.2} &
                \multicolumn{1}{c|}{} &
                \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}Hệ thống sẽ cho phép người dùng Đặt/Huỷ vé xem phim (chỉ huỷ được trong TH đã\\ đặt vé trước đó)\end{tabular}} \\ \hline
            \multicolumn{1}{|c|}{1.3} & \multicolumn{1}{c|}{} & \multicolumn{1}{l|}{Hệ thống sẽ cho phép người dùng Xem lịch chiếu của các phim được chiếu trong rạp} \\ \hline
            \multicolumn{1}{|c|}{1.4} & \multicolumn{1}{c|}{} & \multicolumn{1}{l|}{Hệ thống sẽ cho phép người dùng thanh toán vé đã đặt online qua ví điện tử Momo}  \\ \hline
            \multicolumn{1}{|c|}{2.1} & \multicolumn{1}{c|}{} & \multicolumn{1}{l|}{Hệ thống sẽ cho phép quản lý Đăng nhập/Đăng xuất tài khoản do Admin cấp}          \\ \hline
            \multicolumn{1}{|l|}{2.2} & \multicolumn{1}{c|}{} & \multicolumn{1}{l|}{Hệ thống sẽ cho phép quản lý quản lý lịch chiếu của phim trong rạp}               \\ \hline
            \multicolumn{1}{|l|}{3.1} & \multicolumn{1}{c|}{} & \multicolumn{1}{l|}{Hệ thống sẽ cho phép quản lý quản lý các chương trình khuyến mãi trong rạp}       \\ \hline
            \multicolumn{1}{|l|}{4.1} & \multicolumn{1}{c|}{} & \multicolumn{1}{l|}{Hệ thống sẽ cho phép Admin quản lý các quản lý trong rạp}                         \\ \hline
            \multicolumn{1}{|l|}{5.1} &\multicolumn{1}{c|}{} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}Hệ thống sẽ cho phép Admin thực hiện các thống kê về doanh thu theo \\ phim/ngày/tháng/năm\end{tabular}} \\ \hline
            \multicolumn{1}{l}{}      &                               &                                                                                                      
        \end{tabular}
    ...
    \begin{table}[H]
        \begin{tabular}{ccl} \hline
            ...
            \multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{1} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}Thời gian phát triển phần mềm gói   gọn trong 12 tuần (tính từ lúc viết báo cáo \\ yêu cầu đến lúc hoàn thiện phần mềm)\end{tabular}} \\ \hline
            \multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{1} & \multicolumn{1}{l|}{Bảo mật về thông tin thanh toán và thông tin người dùng} \\ \hline
            \multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{3} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}Thời gian phản hồi của hệ thống dưới 1s trong mọi chức năng trong môi trường\\ lý tưởng (sẽ định nghĩa lại sau)\end{tabular}} \\ \hline
            \multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{2} & \multicolumn{1}{l|}{Quy trình áp dùng: phát triển dần dần + tái sử dụng}     \\ \hline
            \multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{1} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}Giao diện đảm bảo người dùng sử dụng được các chức năng cơ bản (đặt vé,\\ thanh toán online, xem lịch chiếu) trong tối đa 10p làm quen.\end{tabular}} \\ \hline
                                &                               &                                                                             
        \end{tabular}
