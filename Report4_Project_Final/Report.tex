...
\hline
1   & Nguyễn Bảo Long             & \begin{tabular}[c]{@{}l@{}}- Thiết kế, cài đặt front-end\\- Tổng hợp báo cáo\\- Đánh giá sản phẩm\\- Góp ý hướng phát triển\\ \end{tabular}            & 20\%                \\ 
\hline
2   & Phạm Văn Minh Phương        & \begin{tabular}[c]{@{}l@{}}- Thiết kế, cài đặt front-end\\- Tổng hợp báo cáo\\- Đánh giá sản phẩm\\- Góp ý hướng phát triển\\ \end{tabular}            & 20\%                \\ 
\hline
3   & Võ Thế Minh                 & \begin{tabular}[c]{@{}l@{}}- Thiết kế, cài đặt back-end\\- Đánh giá sản phẩm\\- Góp ý hướng phát triển\end{tabular}                                    & 20\%                \\ 
\hline
4   & Phạm Tống Bình Minh         & \begin{tabular}[c]{@{}l@{}}- Thiết kế, cài đặt back-end\\- Triển khai kiểm thử sản phẩm\\- Đánh giá sản phẩm\\- Góp ý hướng phát triển\\ \end{tabular} & 20\%                \\ 
\hline
   ...
   \section{Yêu cầu phần mềm}
    ...
    \begin{itemize}
        ...
        \begin{table}[h]
            ...
            1.7 &     2     & \begin{tabular}[c]{@{}l@{}}Hệ thống sẽ cho phép \textit{khách hàng của rạp phim} \textbf{thanh toán} vé đã đặt online\\ \textbf{qua Paypal}\end{tabular}  \\ \hline
